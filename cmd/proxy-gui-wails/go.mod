...
require (
	...
	github.com/xssnick/tonutils-go v1.11.1-0.20250228100230-8a484bd4b34f // indirect
	github.com/xssnick/tonutils-storage v0.7.1 // indirect
...
replace github.com/xssnick/tonutils-proxy v1.0.0 => ../../
