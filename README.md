...
* [Download Mac (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.0/GUI.Mac.Tonutils.Proxy.dmg) (release is not notarized yet, you need right click on app and click Open)
