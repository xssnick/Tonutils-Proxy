...
* [Download Mac M1 (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.5/GUI.Mac.M1.Tonutils.Proxy.dmg)
* [Download Mac Intel (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.5/GUI.Mac.Intel.Tonutils.Proxy.dmg)
* [Download Windows (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.5/GUI-Windows-x64-Tonutils-Proxy.exe)
* [Download Linux (CLI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.5/cli-tonutils-proxy-linux-amd64)
