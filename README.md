...
* [Download Mac M1 (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.2/GUI.Mac.M1.Tonutils.Proxy.dmg)
* [Download Mac Intel (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.2/GUI.Mac.Intel.Tonutils.Proxy.dmg)
* [Download Windows (CLI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.2/cli-tonutils-proxy-windows-amd64.exe)
* [Download Linux (CLI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v0.1.2/cli-tonutils-proxy-linux-amd64)
