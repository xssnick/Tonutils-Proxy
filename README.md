...
* [Download Mac M1 (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v1.2.0/GUI.Mac.M1.Tonutils.Proxy.dmg)
* [Download Mac Intel (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v1.2.0/GUI.Mac.Intel.Tonutils.Proxy.dmg)
* [Download Windows (GUI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v1.2.0/GUI-Windows-x64-Tonutils-Proxy.exe)
* [Download Linux (CLI)](https://github.com/xssnick/Tonutils-Proxy/releases/download/v1.2.0/tonutils-proxy-cli-linux-amd64)
